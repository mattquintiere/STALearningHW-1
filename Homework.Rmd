...
We will now use hierarchical clustering to analyze the distance between observations and linkage to join groups.

```{r hierarchical}

d = dist(scale(pca_penguins2), method = "euclidean")
